                ...
                {profileOpen && (
                  <div style={{ position: 'absolute', top: 48, right: 0, width: 240, background: 'var(--b2)', border: '1px solid rgba(124,58,237,0.2)', borderRadius: 16, zIndex: 500, boxShadow: '0 20px 60px rgba(0,0,0,0.6)', overflow: 'hidden', animation: 'dropIn .18s ease' }}>
                    ...
                    <div style={{ padding: '8px' }}>
                      ...
                      >
                        <span style={{ width: 30, height: 30, borderRadius: 8, background: 'rgba(124,58,237,0.1)', border: '1px solid rgba(124,58,237,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      ...
                      >
                        <span style={{ width: 30, height: 30, borderRadius: 8, background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
